...
%-------------------------------------------------------------------------------
\name{Lorenzo Rimella}{}
\position{Research Associate (Assegno di Ricerca)}
\address{ESOMAS, Università degli studi di Torino and Collegio Carlo Alberto, Torino, IT}

%\mobile{+1 000-000-0000}
\email{lorenzo.rimella@unito.it}
\homepage{lorenzorimella.github.io}
\github{LorenzoRimella}
\linkedin{lorenzo-rimella-3b5100132}
% \gitlab{my-gitlab-id}
...
\makecvfooter
  {}
  {Lorenzo Rimella ~~~·~~~ Curriculum Vitae}
  {\thepage}
